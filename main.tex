...
\begin{frame}{Truffle: How it works}
	\begin{itemize}
...
public Object add(...) {
    ...
    if (left instanceof Long) left = ((Long) left).doubleValue();
    if (right instanceof Long) right = ((Long) right).doubleValue();
...
\begin{frame}{Code example using annotation-based DSL}
        ...
        \caption{Generated code for code example}
        \label{fig:gencodes}
    \end{figure}
...
\begin{frame}{Type decision chains}
  \begin{figure}
    \centering
