...
Keyword arguments get as fast as position arguments
...
$\rightarrow$ Keyword arguments get as fast as position arguments
\begin{itemize}
...
\begin{itemize}
 \item Lukas Stadler Gilles Duboscq
Hanspeter Mössenböck, Thomas Wurthinger, \textbf{Compilation Queuing and Graph Caching for Dynamic Compilers}, \url{http://lafo.ssw.uni-linz.ac.at/papers/2012_VMIL_Graal.pdf}
 \item Graal (\url{http://hg.openjdk.java.net/graal/graal})
 \item JRuby (\url{https://github.com/jruby/jruby})
 \item JRuby Developer (especially Chris Seaton)
